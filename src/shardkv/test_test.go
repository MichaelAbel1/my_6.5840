...
func TestStaticShards5A(t *testing.T) {
	...
	ck := cfg.makeClient(cfg.ctl) // kvclient与shardctrler连接
...
func TestConcurrent1_5B(t *testing.T) {
	...
	cfg.join(2)
	time.Sleep(500 * time.Millisecond)
	DPrintf("test_test.TestConcurrent1_5B(): leaving group 0")
	cfg.leave(0)
	DPrintf("test_test.TestConcurrent1_5B(): ShutdownGroup 0")
	cfg.ShutdownGroup(0)
	time.Sleep(100 * time.Millisecond)
	DPrintf("test_test.TestConcurrent1_5B(): ShutdownGroup 1")
	cfg.ShutdownGroup(1)
	time.Sleep(100 * time.Millisecond)
	DPrintf("test_test.TestConcurrent1_5B(): ShutdownGroup 2")
	cfg.ShutdownGroup(2)
	DPrintf("test_test.TestConcurrent1_5B(): leaving group 2")
	cfg.leave(2)

	time.Sleep(100 * time.Millisecond)
	DPrintf("test_test.TestConcurrent1_5B(): StartGroup 0")
	cfg.StartGroup(0)
	DPrintf("test_test.TestConcurrent1_5B(): StartGroup 1")
	cfg.StartGroup(1)
	DPrintf("test_test.TestConcurrent1_5B(): StartGroup 2")
	cfg.StartGroup(2)

	time.Sleep(100 * time.Millisecond)
	DPrintf("test_test.TestConcurrent1_5B(): JoinGroup 0")
	cfg.join(0)
	DPrintf("test_test.TestConcurrent1_5B(): leaving group 0")
	cfg.leave(1)
	time.Sleep(500 * time.Millisecond)
	DPrintf("test_test.TestConcurrent1_5B(): JoinGroup 1")
	cfg.join(1)
